...
\begin{abstract}
  ...
  concrete requirements of the editor it supports  as well as implementation constraints.
  ...
  surface syntax alongside new functions.  In particular, \Elisp{} can be customized to look
