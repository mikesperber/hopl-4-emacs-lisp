...
\begin{abstract}
  ...
  %% FIXME: This makes it sound like ELisp started as a "quick hack"
  %% to which "principled programming-language design" was applied only later,
  %% while the choice of Maclisp as the main inspiration was already
  %% a choice of "principled programming-language design" (and Richard
  %% was quite familiar with Scheme as well).
  %%Especially when compared to Mocklisp and TECO!
  %%\Elisp{} has also picked up some ideas from principled
  ...
  In contrast to too many extension or configuration languages, \Elisp{}
  started as a real programming language with powerful abstraction facilities,
  and many Emacs maintainers have been closely related to
