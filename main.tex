...
\begin{table}
  %% FIXME: What is the role of the persons we mentions:
  %% For Emacs it seems to be the official "head maintainer", but for
  %% XEmacs, I'm not sure.
...
\begin{center}
  \begin{tabular}{l|l|l|l}
    ...
    %% FIXME: AFAICT, the mocklisp.[ch] files were removed *after* 21.4
...
Richard Mlynarik implemented a similar change in 1993 for Lucid Emacs 19.8,
giving \Elisp{} 28-bit integers and a 28-bit address space.
For the release of XEmacs 19.13 in 1995, Ben Wing
merged the data representation from Emacs 19.30.
...
Kyle Jones added a ``minimal-tagbits'' configure option to XEmacs with the release
