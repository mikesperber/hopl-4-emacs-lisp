...
%% FIXME Mike: BTW, I remember seeing this unbind_all bytecode and wanting to
...
%% Its main interest was to reduce the
...
aliases, on which the \texttt{define-obsolete-functional-alias}
...
%% FIXME Mike: I assume the resistance was from Richard.
%% Could we give some idea about the reason for the resistance or
%% was it just the fact that he didn't have the time to follow the
%% progress of the implementation and was hence "losing control" in the
%% sense that he wasn't familiar with the code and/or didn't like some
%% of the implementation choices yet didn't have the time/energy to
%% change it?
%% FIXME Stefan: I think it was mostly incompatible personalities.
%% Jamie's take was:
%%
%% "In addition to not listening to any design ideas we had, RMS's
%% policy was to require us to provide source diffs and to explain
%% every changed line. Because our efforts towards release were
%% mounting, and we were re-writing massive amounts of the system,
%% source diffs didn't make sense, but RMS and Blandy were unwilling or
%% unable to work at a higher level. I traveled to Cambridge to work
%% things out, and my team had numerous phone conversations with RMS. "
%%
%% This description certainly fits with the behavior I've seen from
%% Richard, so I assume it's true.  Don't know how to do better
%% wrt. the paper though.
byte-compiler for XEmacs, which, after some initial resistance, was
...
%% FIXME Mike: any idea what kind of speedup this brought?
%% No, Ben Wing tended to submit massive patches where the details got
%% lost in the shuffle.
...
1996, which can provide timing information about function calls and
allocation.  (See Section~\ref{sec:profiler} about the profiling
efforts in Emacs.)
