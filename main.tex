...
TECO editor.  TECO was originally written by Dan Murphy starting in
...
a novelty), which updated the text being edited as typing happened.
This mode allowed mapping characters to commands, and users would typically
configure TECO to bind printing characters to self-insert, and control
chracters would execute TECO macros.  Guy Steele coordinated among the
users, creating a common set of keybindings, which Richard Stallman evolved
into the first version of Emacs~\cite{Seibel2009}.  Note that TECO and Emacs
were not completely separate entities in the sense that TECO's extension
language was also Emacs's extension language and that they evolved together,
where TECO's extension language was regularly extended to provide facilities
...
this \Elisp{} interpreter.  \emph{Gosling Emacs} was then distributed
