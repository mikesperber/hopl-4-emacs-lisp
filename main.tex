...
% FIXME Mike: details about symbols and how property lists work --- A symbol
% had an associated \emph{property list}, essentially a dictionary
% mapping property names (also symbols) to values.
...
variable lookups and let-bindings.  Symbols could be used to refer to
variables.  In particular, the \texttt{set} function, which performed
assignment, accepted the \emph{name} of a variable as its argument. 
