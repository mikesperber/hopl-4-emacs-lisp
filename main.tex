...
%% FIXME: Expand on this, including frame-local vars
...
makes it \emph{buffer-local}.  This associates the value of the
variable with the \emph{current buffer}, a global reference managed
...
Moreover, Emacs features a small number of \emph{terminal-local}
variables.
...
trades off the brittle platform-dependence of the old unexec code with more
