...
Emacs}.  Jamie Zawinski was the primary developer of Lucid Emacs.
...
\newpage
%% FIXME: I think we should strive to make this fit on a single page!
\begin{center}
  \begin{longtabu} to \textwidth {l|l|l|X}
    ...
    &&& Merged Epoch and Emacs 19.8 \\[1ex]
    \EDate{1994-05}{-17} & Emacs 19.23 beta & Richard Stallman \\
    \EDate{1994-05}{-27} & Lucid Emacs 19.10 & Jamie Zawinski \\[1ex]
    \EDate{1994-09}{-13} & XEmacs 19.11 & Chuck Thompson, Ben Wing \\[1ex]
    \EDate{1994-11}{-01} & Emacs 19.28 & Richard Stallman
    & Proper backquote, Sec.~\ref{sec:backquote} \\
    &&& First real release of Emacs 19\\[1ex]
    \EDate{1995-06}{-19} & Emacs 19.29 & Richard Stallman
    & 3-bit tags, Sec.~\ref{sec:data-representation} \\
    1995 & XEmacs 20 && Work on MULE support begins\\[1ex]
    \EDate{1995-09}{-01} & XEmacs 19.13 & Chuck Thompson, Ben Wing
    & Merged Emacs 19.30\\[1ex]
    \EDate{1995-11}{-24} & Emacs 19.30 & Richard Stallman \\[1ex]
    \EDate{1996-05}{-25} & Emacs 19.31 & Richard Stallman \\[1ex]
    \EDate{1996-08}{-21} & Emacs 19.34 & Richard Stallman \\[1ex]
    \EDate{1997-02}{-09} & XEmacs 20.0 & Steve Baur \\[1ex]
    \EDate{1997-03}{-26} & XEmacs 19.15 & Steve Baur \\[1ex]
    \EDate{1997-09}{-17} & Emacs 20.1 & Richard Stallman \\[1ex]
    \EDate{1997-10}{-31} & XEmacs 19.16 & Steve Baur \\[1ex]
    \EDate{1998-02}{-28} & XEmacs 20.4 & Steve Baur
    & First stable release with MULE\\ % support
    &&& Packages shipped separately\\[1ex]
    \EDate{1998-07}{-12} & XEmacs 21.0 && 1-bit tags \\[1ex]
    \EDate{2001-04}{-16} & XEmacs 21.4 & Stephen Turnbull \\[1ex]
    \EDate{2001-10}{-20} & Emacs 21.1 & Gerd Möllmann \\[1ex]
    \EDate{2002-03}{-18} & Emacs 21.2 & Gerd Möllmann
    & Last version with MLisp support, Sec.~\ref{sec:mock-lisp}\\
    \EDate{2007-06}{-01} & Emacs 22.1 & Richard Stallman \\[1ex]
    %% Chong and I started as maintainers in February 2008.
    \EDate{2009-07}{-28} & Emacs 23.1 & Chong Yidong, Stefan Monnier \\[1ex]
    \EDate{2012-06}{-10} & Emacs 24.1 & Chong Yidong, Stefan Monnier \\[1ex]
    \EDate{2014-10}{-20} & Emacs 24.4 & Chong Yidong, Stefan Monnier
    & \texttt{nadvice.el}, Sec.~\ref{sec:hooks}\\ 
    \EDate{2016-09}{-17} & Emacs 25.1 & John Wiegley, Eli Zaretskii \\[1ex]
...
%% FIXME: *mostly* but not completely (e.g. not true at least for Gerd Möllmann
...
%% explanations for why it was the *only* scoping provided (Stallman1981
...
\end{verbatim}
%
This expression evaluates to a nested list structure---\texttt{'}$e$
is read as \texttt{(quote \textnormal{$e$})}---with the
\texttt{lambda} symbol as its first element etc.  When a program calls
...
% contained a use for this function, so the motivation for this is
...
\item[2001] Emacs-21.1 includes the hash-table functions, reimplemented in
  ...
  objects, not as arguments). % FIXME Stefan: What does "objects, not arguments" mean?
