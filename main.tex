...
Section~\ref{early-history}.  Around that time, its development slowed down and
...
%% FIXME Mike: I don't think the above characteristics were part of the
%% motivation to use a "real" language.  Instead, I think Richard had simply
%% plenty of experience with real Lisp implementations to hate MockLisp's
%% quirks and want to replace it with a real language.  So I re-introduced
%% your previous paragraph instead, which I liked better.
...
Section~\ref{FIXMEDumping}.)  Marcus Crestani also replaced the
