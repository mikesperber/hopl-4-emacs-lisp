...
assignment, accepted the \emph{name} of a variable as its argument.  A
symbol had an associated \emph{property list}, essentially a
...
rarely used properly.  So in late 2012 Stefan Monnier developed a new
