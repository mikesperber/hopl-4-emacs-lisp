...
development was done using the revision control system RCS~\cite{RCS}, and
...
files for bootstrap.  When development moved to CVS~\cite{CVS} to ease
...
%% impact the language.
%% Mike: Hmm... OK, I changed it to talk a bit more about the
...
support for inheritance was fundamentally flawed until Emacs-24.1 were it
