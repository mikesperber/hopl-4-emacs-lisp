...
%% FIXME Mike: in current XEmacs I can only find define-obsolete-function-alias
%% Has it changed name since its introduction (without leaving its
%% own obsolete-function-alias ;-), or is that just a typo?
...
%% FIXME Mike: we tend to use XEmacs a bit everywhere, but I wonder if we
...
%% FIXME: Maybe this should be moved to the sec:profiler section (which
%% itself should maybe move to an earlier part of the paper)?
While not directly a performance improvement to the \Elisp{}
%% FIXME Mike: Could you give a bit more info (e.g. is it sampling-based, or
%% instrumentation-based, or something else?)
