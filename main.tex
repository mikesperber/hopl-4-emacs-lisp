...
%% FIXME: I think we should mention the actual underlying representation
%% of characters in the C code (the text above suggests it was an actual pair of
%% character set and codepoint, which would suggest it was heap allocated).
...
%% FIXME: I don't quite understand what you're saying here, I think you mean
%% that XEmacs discouraged the practice of treating a char like a number,
...
\subsubsection{Eager macro-expansion} %Emacs-24.3?
...
\subsubsection{Pcase}           %Released in Emacs-24.1
...
\item [Emacs-24.1]: \textt{macroexpand-all} and lexical-scoping, which
