...
%% type of numbers (e.g. Emacs only has mpz whereas IIUC XEmacs has also
%% mpq and mpf), interaction with print&read, with `eql`, and with other
%% primitives, whether or not it was optional, ...
