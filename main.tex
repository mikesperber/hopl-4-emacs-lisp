...
%% FIXME Stef: update on recent changes in this regard
...
%% *** FIXME Mike: IIRC there was a round of micro-optimisation in the
...
%% shines, ...).
%% FIXME Stefan: better?
%% Yes, much better, thanks, tho now I want even more that code in Emacs!
