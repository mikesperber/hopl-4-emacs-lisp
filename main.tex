...
\begin{center}
  \begin{longtabu} to \textwidth {l|p{2in}|X}
    ...
    text properties, Sec.~\ref{sec:strings}; \texttt{advice.el}, Sec.~\ref{sec:hooks}
    \\
    & (Joe Arcenaux)\\[1ex]
    1990-08-27 & Epoch 4.0\\
    & (Marc Andreesen)\\[1ex]
    1990-04 & Lucid Emacs 19.0  & extents, Sec.~\ref{sec:strings} \\
    & (Jamie Zawinski)\\[1ex]
    1992-10-31 & GNU Emacs 18.59 \\
    & (Richard Stallman)\\
    & last release of Emacs 18\\[1ex]
    1993-05-22 & GNU Emacs 19.7 beta & \texttt{lambda} macro, Sec.~\ref{sec:lambda}
    \\
    & (Jim Blandy)\\
    ...
    XXXX-XX-XX & XEmacs 21.0 & 1-bit tags
    \\[1ex]
    2001-04-16 & XEmacs 21.4\\
    & (Stephen Turnbull)\\[1ex]
    2001-10-20 & GNU Emacs 21.1\\
    & (Gerd Möllmann)\\[1ex]
    2001-XX-XX & GNU Emacs 21.2 & last version with MLisp support, Sec.~\ref{sec:mock-lisp}\\
    ...
    & (Chong Yidong, Stefan Monnier)\\[1ex]
    201X-XX-XX & GNU Emacs 24.4 & \texttt{nadvice.el}, Sec.~\ref{sec:hooks}\\ 
    & (Chong Yidong, Stefan Monnier)\\[1ex]
    2016-09-17 & GNU Emacs 25.1\\
    & (John Wiegley, Eli Zaretskii)\\[1ex]
    2018-05-28 & GNU Emacs 26.1\\
    & (John Wiegley, Eli Zaretskii)\\
    XXXX-XX-XX & GNU Emacs 27 & old-style backquotes removed, Sec.~\ref{sec:backquote}
  \end{longtabu}
\end{center}
