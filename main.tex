...
A symbol had an associated \textit{property list}, essentially a
dictionary mapping property names (also symbols) to values.
...
% FIXME: Do we need to talk about advice?
