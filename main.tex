...
kind of objects: cons cells, floats, symbols, markers, and
...
\texttt{malloc} was too slow, but that the implementation of
...
(which internally represents those objects as vectors, see
Section~\ref{sec:structures}) became much more
...
Lisp's \texttt{defstruct} early on (see Section~\ref{sec:structures}, including the
