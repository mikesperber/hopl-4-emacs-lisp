...
*** TODO 298. Why does Emacs begin with 13.0 rather than 1.0?
*** TODO 569 “soon” does this mean within months, a year, a few years, or a decade?
*** TODO 591. When does one use “quote” and when does one use the alternative “function”?
*** TODO 612. CONS —> KONS, twice
*** TODO 667. Spell out contents of <handle>.
It is obvious to you, but not to the reader.
*** TODO 718. Does “code in defadvice form” mean
(about ...) or (with-elisp-eval-region ...)?
*** TODO 719. What is the difference between explicit and implicit delegation?
*** TODO 821. mapping1 —> mapping
*** TODO 988-993. So there are 31-bit integers but 30-bit pointers?
If this is correct, best to say so explicitly; if not, I have misunderstood
and you need to rewrite.
*** TODO 1004. “multiple of 8” —> “multiple of 8 bytes”
(to clarify the connection to 64 bits)
*** TODO 1040. Maybe better if 5.4.1 and 5.4.2 are separate sections?
...
*** TODO 1126. mmaped —> mmapped?
*** TODO 1175. And the third argument is optional, and also a form to be instrumented if present.
*** TODO 1284. “This creates problems” What does?
“This” should only be used when it refers to an immediately preceding noun
phrase, which here it does not. Rephrase.
*** TODO 1440. “First shipped with XEmacs 19.15 and XEmacs 20.1”
What does this mean? How does this differ from just shipping with XEmacs 19.15?
*** TODO 1458. “, ,”
*** TODO 1459. “supplanting potentially convoluted documentation”
I have no idea of what the given :type means or what documentation it might supplant.
*** TODO 1543. analog —> analogy
*** TODO 1724. There is a whole other paper on hygiene,
so possibly a few words on hygiene (or lack of it?) in Emacs Lisp macros is
in order.
*** TODO 1755-1756. Emacs 18.51 vs Emacs-19.18. Be consistent throughout the paper.
*** TODO 1833. “reworked in cl-lib.el to provide those features
...
*** TODO 1854. —> “macros can invoke get-setf-expansion to turn a place into ...”
*** TODO 1881. “we” does this mean Stefan Monnier again, or a group of people?
If the latter, who?
*** TODO 1934. Please include the actual body of distance for 3d points
rather than a message.
*** TODO 2061. “its own luck” —> “his own luck”
*** TODO 2117-2125. This discussion left me unclear on how define-inline actually works.
Perhaps an example of how it is used to define cl-typep would help.
*** TODO 2152. What was not thorough about with-namespace?
...
*** TODO 322 - No maintainer is listed for XEmacs 20. Is this deliberate? (Also this
     line is a bit different than the others, as it talks about a version in
     development not the most recently released version.)
*** TODO 355 - "imported"
*** TODO 356 - "CVS repository on *the* SourceForge"
*** TODO 393 - extra comma
*** TODO 400 - is this comment added by you, from the manual, or from the original
      source code?
*** TODO 419 - define homoiconic (I see you do below, but it is referred to prior here)
*** TODO 488 - this text is hard to follow. What is a "symbol object" ?
*** TODO 516 - "added as on option"
*** TODO 551 - (and elsewhere) The quote used here (and elsewhere in the text) is like
      neither of the quotes used earlier. There is something weird going on
		with the font.
*** TODO 569 - Is it possible to mechanically convert these packages? If not, why?
*** TODO 583 - Does this mean that the lambda symbol could be computed? Did any code
      ever do this?
*** TODO 697 - Is defadvice the same idea as "Aspect-Oriented Programming"?
*** TODO 821 - "mapping1"
...
*** TODO [355] "imorted" -> "imported"
*** TODO [356] "on SourceForge" -> "on the SourceForge"
*** TODO [431] "runtime" -> "run time"
*** TODO [611] I believe there are typos here in reference to the example code: "MAKE-CONS" -> "MAKE-KONS", "CONS" -> "KONS".
*** TODO [619] You write ", see Section 6.1."  You may wish to check a style guide on this, but I suggest either make it non-parenthetical -> "as discussed in Section 6.1." or explicitly parenthetical -> "(Section 6.1)".    You should settle on a style and apply it consistently.  See for example [1128].
*** TODO [624] ditto.
*** TODO [656] "if expression" -> "if the expression"
*** TODO [699] "fitting very well the design goals" -> "fitting the design goals very well"
*** TODO [821] "mapping1" -> "mapping"
*** TODO [873] "design aspects" -> "aspects of the design"
*** TODO [885] "just with" -> "with"
*** TODO [901] "There have been" -> "There were"
*** TODO [925] "Until 2002 during" -> "Until 2002, during"
*** TODO [949] "24-bit of" -> "24-bits of"
*** TODO [954] "objects:" -> "object:"
*** TODO [969] Minor style issue.  Some style guides suggest spelling out numbers when they arise in prose and have a single word in English, so "6" -> "six", "2 words of header" -> "two words of header".   This is a minor issue, but you may wish to consider it, and if so apply the style consistently.
*** TODO [983] "beause" -> "because"
*** TODO [995] "use all the" -> "use all of the"
*** TODO [1019] "objects" -> "object"
*** TODO [1027] "second" -> "second,"
*** TODO [1038] "tho" -> "though"
*** TODO [1096] you say that it is based on a _read_ barrier, but on [1110] the text suggests it was a _write_ barrier.   You may want to check this.
*** TODO [1128] misplaced period at end of sentence
*** TODO [1173] "is just a mere" -> " is a mere"
*** TODO [1233] "discussions whether" -> "discussions of whether"
*** TODO [1237] "all the" -> "all of the"
*** TODO [1259] "design---here" -> "design. Here"
*** TODO [1287] "Eventually however" -> "Eventually, however"
*** TODO [1458] ", ," -> ","
*** TODO [1506] "It's only in August" -> "It was only in August"
*** TODO [1527] "that, if" -> "that if"
*** TODO [1549] "specifiers. which" -> "specifiers, which"
*** TODO [1695] I didn't know Emacsen was a word.  I do [now](https://www.emacswiki.org/emacs/Emacsen)!
*** TODO [1754] "so already in 1986 .. wrote" -> "so by 1986 .. had already written"
*** TODO [1774] "name" -> "epithet" ?
*** TODO [1779] "and of" -> "and"
*** TODO [1816] "lead to poorly readable code" -> "lead to code that is difficult to read"
*** TODO [1880] "not-invented-here syndrome" - I wasn't clear on whose part (Stefan? or the community?)
*** TODO [1905] "4.4" -> "4.4)"
*** TODO [1913] "the way it sounds" I suspect rather, it's a because of the comic reference to the nursery rhyme.
*** TODO [1945] "that it is" -> "that it was"
*** TODO [1973] incorrect citation style 
*** TODO [2004] "supports equally ..." -> "supports ... equally"
*** TODO [2010] "We" who?  The community?  The authors? Perhaps disambiguate.
*** TODO [2092] "that buffers's contents" -> "that the buffer's contents" (or plural "that the contents of the buffers")
