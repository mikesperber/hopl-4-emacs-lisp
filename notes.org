...
*** TODO "Greenspun's tenth rule" Citation please! Not all your readers will
know it.
...
*** TODO "attaching code to functions even if they do not run hooks" Does this
...
*** TODO "makes better use of existing language features" Obscure. Explain or
give a citation.
...
*** TODO "the "mark" bit was not used" I'm confused. If it wasn't used for this
purpose, how were objects marked?

*** TODO "each object by allocated" --> "each object be allocated"

*** TODO If there are just eight object types, perhaps it would be
worthwhile to list them all?

*** TODO "merged that data representation of Emacs 19.30" I can't work out what
...
*** TODO "very early" Is Emacs-16.56 really very early?

*** TODO p16

*** TODO Section 5.10.  End first paragraph with the sentence "Modifying
...
*** TODO "compared to Nickolas" --> "compared to Lloyd"
