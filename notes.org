...
*** TODO Mike I could not discern an order to the subsections of Section 4. Possibly
...
*** TODO Stefan A word or two on uses of the concurrency package would be welcome.
...
*** TODO Stefan - 4.5: "C-u (to specify powers of 4)" ? What is this design? Why powers of 4?
...
*** TODO Stefan - 4.8: Is the defadvice feature used in practice? How? How was nadvice
...
*** TODO Mike - 5.7: "These were solved very simply in Emacs-19.31 by removing messages that
...
*** TODO Mike - 6.1: Am I supposed to understand the keymap representation from this
...
*** TODO Stefan - 8.4: The timeline of integration of common lisp functions into Elisp seems
...
*** TODO Stefan - p6 "Richard Stallman felt" it would be great if you could provide references to such comments (I understand that this may not be possible).
...
*** TODO Stefan - p11 the comment connecting bootstrap with RCS -> CVS transition is interesting, but needs a little bit more information. 
...
*** DONE - p16 "show a an" -> "show an"
    CLOSED: [2019-05-26 Sun 17:05]
*** TODO Stefan - p17 "affect function calls" what does this mean?  Are you referring to inlining?
